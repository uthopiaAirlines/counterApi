...
public class FlightTest {
    ...
    void setFlight() {
        ...
        flight.getAirline().setAirlineId(1);
        flight.setArrivalLocation(new Airport());
        flight.getArrivalLocation().setAirportId(1);
        flight.setArrivalTime(OffsetDateTime.now());
        flight.setAvailableSeats(1);
        flight.setDepartureLocation(new Airport());
        flight.getDepartureLocation().setAirportId(3); 
